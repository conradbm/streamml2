...
X2 = TransformationStream(newsgroups_train.data, corpus=True, method="count").flow(["scale","normalize","pca","poly"], params={"poly__degree":3, "pca__n_components":2})
print(X2)
...
X2 = TransformationStream(X).flow(["pca","normalize","binarize","poly","kmeans"],
